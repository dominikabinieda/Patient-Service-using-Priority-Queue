...
class SOR(tk.Frame, tk.Entry):
    ...
    def wyswietl_pacjentow(self):
        ...
        while self.kolejka.is_empty() == False:
            ...
            komunikat = komunikat + "pacjent: " + str(item[0][0]) + " " + str(item[0][1]) + ", numer PESEL: " + str(
                item[0][2]) + ", priorytet: " + str(item[1]) + '\n'
    ...
    def przyjety(self):
        ...
        self.i = 0
        if len(self.lista) > 0:
            komunikat = [self.lista[self.i][0], self.lista[self.i][1], (self.lista[self.i][2]),
                         str("pacjent przyjęty na oddział: ") + str(
    ...
    def wypis(self):
        ...
        if len(self.lista) > 0:
            komunikat = [self.lista[self.i][0], self.lista[self.i][1], (self.lista[self.i][2]),
                         str("wypis do domu: ") + str(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()))]
            print(komunikat)
            self.lista_wypisanych.append(komunikat)
            if self.i == 0:
                del self.lista[self.i]
    ...
    def smierc(self):
        ...
        if len(self.lista) > 0:
            komunikat = [self.lista[self.i][0], self.lista[self.i][1], (self.lista[self.i][2]),
                         str("pacjent zmarł: ") + str(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()))]
            print(komunikat)
            self.lista_wypisanych.append(komunikat)
            if self.i == 0:
                del self.lista[self.i]
